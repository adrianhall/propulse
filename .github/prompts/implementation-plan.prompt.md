...
Each step of the implementation plan should be written as Markdown in a separate file (e.g. phase1/implementation-step-1.md) as if it were being given to a different developer to complete. 
